<x-guest-layout>
    ...
    <x-alert title="Bienvenido" class="my-5">
        <x-slot name="content">
            Por favor ingrese las credenciales de para iniciar sesión.
        </x-slot>
    </x-alert>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center mt-4 mb-3">
            <x-primary-button class="flex justify-center py-3 shadow-2xl w-full">
                {{ __('Log In') }}
            </x-primary-button>
        </div>
    </form>
